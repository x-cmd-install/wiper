...
- **Upstream**: <https://github.com/ikebastuz/wiper>
- **License**: MIT
...
- **Releases**: 5 · **Merged PRs**: 14 · **Open PRs**: 2 · **Closed issues**: 6 · **Open issues**: 10 · **Commits**: 125
...
Reported by **8** distros on [repology.org](https://repology.org/project/wiper). **8** are ✅ on the latest upstream release, **0** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T20:14:48Z._
